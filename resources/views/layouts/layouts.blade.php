...
<head>
    ...
    <img src="" alt="">
    <title> <img src="" alt=""> @yield('title')</title>
...
<body id="body_layout" class="loading" data-layout-color="light"  data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
...
<div id='wrapper' class="content row">
    ...
    <div class="main_content col-11">
        <div class="row">
            <div class="col-7 d-flex justify-content-between main-content-header">
                <div class="main-content-header {{$user_self['status_']==\App\Constants::ACTIVE?'d-none':''}}" id="active_status_content">
                    <a type="button" onclick="activateOrDisactivate('{{App\Constants::ACTIVE}}')" class="btn border_r_10 edit_button d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#change_user_status">{{$status_activate_text}}</a>
                </div>
                <div class="main-content-header {{$user_self['status_']==\App\Constants::NOT_ACTIVE?'d-none':''}}" id="disactive_status_content">
                    <a type="button" onclick="activateOrDisactivate('{{App\Constants::NOT_ACTIVE}}')" class="btn border_r_10 delete_button d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#change_user_status">{{$status_disactivate_text}}</a>
                </div>
                <div class="main-content-header">
                    <h6>{{$user_self['name'].' '.$user_self['surname'].' '.$user_self['middlename'] }} </h6>
                </div>
            </div>
